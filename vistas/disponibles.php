...
$equipos = RepositorioEquipo::obtenerEquiposDisponibles(Conexion::obtenerConexion())
?>
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="row parte-gestor-gen">
                <div class="col-md-12">
                    ...
                    <br>
                    <caption>
                        <a class="btn btn-primary" href="<?php echo RUTA_HOME; ?>" role="button"><i class="fas fa-sync-alt"></i> Actualizar</a>
                    </caption>
                    <br>
                    <br>
                </div>
            ...
            <div class="row parte-gestor-gen">
                <div class="col-md-12">
                    ...
                    if (count($equipos) > 0) {
                    ?>
                        <table class="table table-condensed" id="tablaEquiposDisp">
                            <thead>
                                <tr>
                                    <th>Serial</th>
                                    <th>Marca</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $fila['num_piso']; ?></td>
                                        <td>
                                            <button type="button" class="btn btn-success" onclick="preguntarSiNoPrestamo('<?php echo $fila['cod_equ'] ?>','<?php echo $_SESSION['id_usuario'] ?>')"><i class="fas fa-plus"></i>
                                            </button>
                                        </td>
                                    </tr>
                                <?php
                    ...
                    ?> <h3 class="text-center">No hay equipos disponibles en el momento</h3>
                        <br>
                        <br>
                        <br>
                    <?php
