...
$equipos = RepositorioEquipo::equiposSindevolver(Conexion::obtenerConexion(),$_SESSION['id_usuario']);
?>
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row parte-gestor-gen">
                <div class="col-md-12">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-warning" onclick="preguntarSiNoDevolver('<?php echo $fila['cod_equ'] ?>','<?php echo $fila['cod_pres'] ?>')"><i class="fas fa-share"></i>
                                            </button>
                                        </td>
                                    </tr>
                                <?php
                    ...
                    ?> <h3 class="text-center">No tiene devoluciones pendientes</h3>
                        <br>
                        <br>
                        <br>
                    <?php
