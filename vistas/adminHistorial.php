...
$historial = RepositorioPrestamo::obtenerHistorial(Conexion::obtenerConexion());
?>
<div class="row parte-gestor-gen">
    <div class="col-md-12">
        ...
        <br>
        <caption>
            <a class="btn btn-primary" href="<?php echo RUTA_HISTORIAL; ?>" role="button"><i class="fas fa-sync-alt"></i> Actualizar</a>
        </caption>
        <br>
        <br>
    </div>
...
<div class="row parte-gestor-gen">
    <div class="col-md-12">
        <table class="table table-condensed" id="tablaHistorialpres">
            <thead>
                <?php
