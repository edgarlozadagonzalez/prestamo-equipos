...
$personas = RepositorioPersona::obtenerPersonas(Conexion::obtenerConexion())
?>
...
<div class="row parte-gestor-gen">
    <div class="col-md-12">
        ...
        <br>
        <caption>
            <a class="btn btn-primary" href="<?php echo RUTA_GESTOR_PERSONAS; ?>" role="button"><i class="fas fa-sync-alt"></i> Actualizar</a>
        </caption>
        <br>
        <br>
    </div>
...
<div class="row parte-gestor-gen">
    <div class="col-md-12">
        ...
        if (count($personas) > 0) {
        ?>
            <table class="table table-condensed" id="tablaPersonas">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-danger glyphicon glyphicon-remove" onclick="preguntarSiNoPersona('<?php echo $fila['cod_per'] ?>')">
                                </button>
                            </td>
                        </tr>
                    <?php
        ...
        ?> <h3 class="text-center">No hay personas registradas</h3>
            <br>
            <br>
            <br>
        <?php
